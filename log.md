...
- 策略: RSI2_NEW
- 资产: CRYPTO
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi2_new_crypto_20260506_081807`
- 更新: index.md, log.md


## [2026-05-06] pipeline | RSI2 CRYPTO 批量回测写入 Wiki
- 新增合成报告: [[rsi2-crypto-batch-2026-05-06]]
- 策略: RSI2
- 资产: CRYPTO
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi2_crypto_20260506_081805`
- 更新: index.md, log.md


## [2026-05-06] pipeline | RSI CRYPTO 批量回测写入 Wiki
- 新增合成报告: [[rsi-crypto-batch-2026-05-06]]
- 策略: RSI
- 资产: CRYPTO
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi_crypto_20260506_075543`
- 更新: index.md, log.md


## [2026-05-05] pipeline | PB CRYPTO 批量回测写入 Wiki
- 新增合成报告: [[pb-crypto-batch-2026-05-05]]
- 策略: PB
- 资产: CRYPTO
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/pb_crypto_20260505_193147`
- 更新: index.md, log.md


## [2026-05-05] pipeline | RSI CN 批量回测写入 Wiki
- 新增合成报告: [[rsi-cn-batch-2026-05-05]]
- 策略: RSI
- 资产: CN
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi_cn_20260505_161907`
- 更新: index.md, log.md


## [2026-05-03] pipeline | RSI ETF 批量回测写入 Wiki
- 新增合成报告: [[rsi-etf-batch-2026-05-03]]
- 策略: RSI
- 资产: ETF
- 批次目录: `data/batch_results/rsi_etf_20260503_175559`
- 更新: index.md, log.md


## [2026-05-03] pipeline | RSI CN 批量回测写入 Wiki
- 新增合成报告: [[rsi-cn-batch-2026-05-03]]
- 策略: RSI
- 资产: CN
- 批次目录: `data/batch_results/rsi_cn_20260503_175559`
- 更新: index.md, log.md
...
- 策略: RSI
- 资产: CRYPTO
- 批次目录: `data/batch_results/rsi_crypto_20260503_175559`
- 更新: index.md, log.md
...
- 策略: RSI
- 资产: ETF
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi_etf_20260503_175559`
- 更新: index.md, log.md
...
- 策略: RSI
- 资产: CN
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi_cn_20260503_175559`
- 更新: index.md, log.md
...
- 策略: RSI
- 资产: CRYPTO
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi_crypto_20260503_175559`
- 更新: index.md, log.md


## [2026-05-03] pipeline | RSI ETHUSDT_SWAP_OKX 批量回测写入 Wiki
- 新增合成报告: [[rsi-ethusdt_swap_okx-batch-2026-05-03]]
- 策略: RSI
- 资产: ETHUSDT_SWAP_OKX
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi_ETHUSDT_SWAP_OKX_20260503_170957`
- 更新: index.md, log.md
...
- 策略: RSI
- 资产: CN
- 批次目录: `/root/.openclaw/workspace/cta_developer/data/batch_results/rsi_cn_20260503_165351`
- 更新: index.md, log.md
