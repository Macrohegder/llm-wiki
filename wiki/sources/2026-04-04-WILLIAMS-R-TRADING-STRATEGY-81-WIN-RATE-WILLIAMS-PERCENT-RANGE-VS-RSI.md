# WILLIAMS %R TRADING STRATEGY – 81% WIN RATE – WILLIAMS PERCENT RANGE VS RSI  📉

**Source**: [[2026-04-04-WILLIAMS-%R-TRADING-STRATEGY-–-81%-WIN-RATE-–-WILLIAMS-PERCENT-RANGE-VS-RSI--📉]] | [Unknown](https://quantifiedstrategies.substack.com/p/williams-r-trading-strategy-81-win-54a)
**Date**: 2026-04-04
...
2
Share
Williams %R does work. In this post, we explain how to use Williams %R in a...

## Key Insights

1. **原文来源**: [Unknown](https://quantifiedstrategies.substack.com/p/williams-r-trading-strategy-81-win-54a)
...
The best result is a two-day lookback period. This gives this equity curve (shown below) for SPY since its inception until today.
We also tested different trading strategies of Williams %R vs. RSI. Check out how it performs on S&P 500 and RSI >>
