...
| pivot | lag | break | Sharpe | 交易数 | 回撤 |
|-------|-----|-------|--------|--------|------|
| 10 | 20 | 15 | **0.717** | 94 | 0.1% |
| 10 | 20 | 10 | 0.691 | 109 | 0.1% |
| 6 | 8 | 30 | 0.643 | 77 | 0.1% |
| 6 | 10 | 30 | 0.643 | 77 | 0.1% |
| 6 | 12 | 30 | 0.643 | 77 | 0.1% |

### 关键差异与不确定性
1. **参数未知**: pivot lookback、compression lag、breakout window 均为假设，优化后参数可能与原文不同
...
5. **回撤异常**: 优化参数显示回撤仅 0.1%，可能是计算口径差异或数据问题，需进一步验证
