...
| ES.CME | 🟢 Green | 1.75 | 332 | -18.6% | - |
| NQ.CME | 🔴 Red | -2.50 | 346 | -232% | - |
| CL.NYMEX | 🟡 Yellow | -0.06 | 840 | -1.1% | - |
| GC.COMEX | 🔴 Red | -0.36 | 570 | -31.2% | - |

**品种适配结论**：策略在股指期货（RTY/ES）上表现优秀，但不适用于科技股指数（NQ）和商品期货（CL/GC）。
