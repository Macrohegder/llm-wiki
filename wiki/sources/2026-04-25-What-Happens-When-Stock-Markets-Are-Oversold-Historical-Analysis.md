...
**Source**: [[2026-04-25-What-Happens-When-Stock-Markets-Are-Oversold?-(Historical-Analysis)]] | [Quantified Strategies](https://quantifiedstrategies.substack.com/p/what-happens-when-stock-markets-are-6d1)
**Date**: 2026-04-25
...
1
Share
When stock markets are oversold, we can expect strong returns over the next few...

## Key Insights

1. **原文来源**: [Quantified Strategies](https://quantifiedstrategies.substack.com/p/what-happens-when-stock-markets-are-6d1)
...
We do a simple backtest that has the rules as below:
