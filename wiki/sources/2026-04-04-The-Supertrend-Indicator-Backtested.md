...
**Source**: [[2026-04-04-The-Supertrend-Indicator-Backtested]] | [Unknown](https://quantifiedstrategies.substack.com/p/supertrend-indicator)
**Date**: 2026-04-04
...
1. **原文来源**: [Unknown](https://quantifiedstrategies.substack.com/p/supertrend-indicator)
...
Buy Signal:
When the closing price of a bar crosses above the previous Supertrend value (turning bullish).
Sell Signal:
When the closing price crosses below the previous value (turning bearish).
