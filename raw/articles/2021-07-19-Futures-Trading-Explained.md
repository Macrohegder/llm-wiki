...
author: "QuantInsti"
source: "QuantInsti"
url: "https://blog.quantinsti.com/futures-trading/"
date: "2021-07-19"
...
**来源**: [QuantInsti](https://blog.quantinsti.com/futures-trading/)  
**日期**: 2021-07-19  
**作者**: QuantInsti
...
The futures market forms an integral part of the derivativemarket. Before understanding the future market, it is very important to understand the concept of the forward market.
...
Near month -A contract that is about to expire in the current month is a near month contract. In January, a near month contract will expire January.

Next month -A contract that is about to expire in the next month is a next month contract. In January, next month's contract will expire in February.

Far month -A contract that is about to expire in the next to next month is a far month contract. In January, next month's contract will expire in March.
...
Thus the ticker of theJanuary 2021 Goldcontract will beGCF1.
...
Therefore, you can say that the futures market is aZero-Sum Game.This means that the pot in the future market never grows. Money simply transfers from the losers to the winners. The profit made by the buyer is equivalent to the loss made by the seller and vice-versa.
...
For along position, we calculate the pullback as per the below formula.$$Pullback=\frac{Close~price-Rolling~highest~price}{Volatility~of~the~asset}$$A long exit signal is generated if the pullback is less than -3.

For ashort position, we calculate the pullback as per the below formula.$$Pullback=\frac{Close~price-Rolling~lowest~price}{Volatility~of~the~asset}$$A short exit signal is generated if the pullback is greater than 3.
...
As per an index futures contract, you are obliged to trade a specific stock index at a predetermined price at a fixed date in future. Explore the blog onIndex Futuresto dive deeper into concepts.
...
In this blog, we covered the characteristics and parameters of futures markets. We also saw the trend following strategy. Explore ourFutures Trading Courseto dive deeper into the concept and gain knowledge on how to trade systematically in the futures market.
