...
**原文链接**: https://quantifiedstrategies.substack.com/p/simple-moving-average-trading-strategy-919

**发布时间**: Jun 22, 2025

**抓取时间**: 2026-04-04 22:03:52
...
Subscribe
Strategy 1:
When the close of SPY crosses BELOW the N-day moving average, we buy SPY at the close. We sell when SPY's closes ABOVE the same average. We use CAGR as the performan...
...
Strategy 1 and Strategy 2 returned the following results as shown in the image below.
This Substack is reader-supported. To receive new posts and support my work, consider becoming a free or paid subscriber.
Subscribe
2
1
