# Intraday Trading Strategies — Backtests Analysis and Evaluation

**原文链接**: https://quantifiedstrategies.substack.com/p/intraday-trading-strategies-backtests-0c8

**发布时间**: Apr 11, 2024

**抓取时间**: 2026-04-04 21:50:04
...
The strategy and logic are straightforward: we want to enter a position after a series of lower lows and lower highs in a row and We make the following tr...
...
Share
Intraday trading strategies refers to a style of trading where a trader buys and sells a financial instrument within the same trading day. The financial instrument can be stocks, futures, or forex. Intraday trading can be scalping — a trading method that tries to profit from small price fluctuations that happen all through the trading day. It can also be day trading — a trading method that aims to capture the major price movements of each trading day but ensures to close all positions before the market closes for the trading day.
The strategy and logic are straightforward: we want to enter a position after a series of lower lows and lower highs in a row and We make the following trading rules:
We use hourly bars.
...
The strategy is backtested on the WTI crude oil futures contract traded on NYMEX. The equity curve looks like the image shown below (2000–2021)
1
Share
Previous
Next
