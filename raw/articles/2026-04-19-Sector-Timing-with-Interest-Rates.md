...
**原文链接**: https://www.quantseeker.com/p/sector-timing-with-interest-rates

**发布时间**: Nov 03, 2025

**抓取时间**: 2026-04-19 22:26:48
...
In this update, I revisit that
Rate Momentum
strategy to see how it has held up since the original post, during 2025, a year that has been anything but quiet for rates. After the sharp declines in yields early in 2025, markets reversed course mid-year amid renewed tariff and inflation concerns, with long-term yields briefly climbing back above 5%. These swings created a challenging environment for traditional momentum and sector-trend models. The goal here is to see whether the Rate Momentum framework could adapt through such macro turbulence and continue to deliver strong performance.
